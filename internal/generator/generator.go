...
func New(version, typeName, path string) (*Generator, error) {
	if typeName == "" {
...
var enumTemplate = template.Must(template.New("enum").Funcs(funcMap).Parse(`// Code generated by enumgen {{.Version}}; DO NOT EDIT.
